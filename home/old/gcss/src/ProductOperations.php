...
{
    //traditional oauth flow functions : start
    ...
    //traditional oauth flow functions : ends

    //service based oauth functions : starts
    public static function UpdateProducts($products, &$context)
    {
        $message = '';
        foreach ($products as $product_nodes) {
    ...
    public static function UpdateProductsFinishedCallback($success, $results, $operations)
    {
        ...
        if ($success) {
            // $message = \Drupal::translation()->formatPlural(
            //     count($results),
            //     'One merchant account processed.', '@count merchant accounts processed.'
            // );
    ...
    //service based oauth functions : ends
