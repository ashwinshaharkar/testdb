 ...
 */
abstract class ProtectedFileTestBase extends WebTestBase {
   ...
   *
   * @return string|bool
   *   Url target on success, or FALSE on failure.
   */
  protected function getUrlLink($label, $index = 0) {
    return $this->getUrlLinkHelper($label, $index, '//a[normalize-space()=:label]');
  }
   ...
   *
   * @return bool|string
   *   Url target, or FALSE on failure.
   */
  protected function getUrlLinkHelper($label, $index, $pattern) {
